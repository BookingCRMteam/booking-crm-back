...
- Create a branch with the name feature/your-feature-name from dev. The first part is type that can be 'feature', 'fix' or 'docs'
...
- Here is a good [article](https://cbea.ms/git-commit/) about making Git commit messages
